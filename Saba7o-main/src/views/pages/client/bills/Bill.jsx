...
function Bill({ bill, payBill, accounts }) {
  // payModal
  const [modal, setModal] = useState(false);
  var ratio = "16%";
  return (
    <>
    <PayBillModal modal={modal} setModal={setModal} bill={bill} payBill={payBill} accounts={accounts} />
    <Row
      style={{
    ...
    >
      {bill === undefined ? (
        ...
        <>
          ...
          />
          {/* buton to pay */}
          <div style={{ display: "flex", flexDirection: "row", width: ratio }}>
            <Button color="info" style={{ marginTop: 0, marginBottom: 0 , borderRadius:7}}>
              Pay
            </Button>
          </div>
        </>
